            ...
            <div class="row">
               ...
               <div class="col-md-4">
                  <div class="box_text">
                     ...
                     <p>community of chargepoint owners help EV drivers by wiping out charging deserts and providing a wide charging network</p>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="box_text">
                     ...
                     <div class="row">
                        <div class="col-md-4 margin_bottom1">
                           <div class="product_box">
                              <figure><img src="./assets/images/user1.png" alt="#"/></figure>
                              <h3>USER 1</h3>
                           </div>
                        </div>
                        <div class="col-md-4 margin_bottom1">
